...
if (!isset($username) || !$username) {
    echo $html->link(__('Create an account now', true), array('controller' => 'users', 'action' => 'register'));
}
?>
<h3>Password</h3>
...
<?php 
if (isset($username)) {
    echo $html->link(__('Edit your account information now', true), array('controller' => 'accounts', 'action' => 'edit'));
}
?>
</p>
...
<?php 
if (isset($username)) {
    echo $html->link(__('Change this setting now', true), array('controller' => 'accounts', 'action' => 'opt_in'));
}
?>
</p>
