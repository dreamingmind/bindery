...
<?php echo $this->Form->create('ExhibitSupliment');?>
	<fieldset>
 		<legend><?php __('Edit Exhibit Supliment'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ExhibitSupliment.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ExhibitSupliment.id'))); ?></li>
