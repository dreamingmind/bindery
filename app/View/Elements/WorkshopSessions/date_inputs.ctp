<tr id="row">
	...
	<td>
		<?php 
		echo $this->Form->input('Date.start_time', array('type' => 'text', 'div' => FALSE));
		echo $this->Form->input('Date.date_start_slide', array(
			'type' => 'range',
			'min' => '0',
			'max' => '38',
			'step' => '1',
	...
	<td>
		<?php 
		echo $this->Form->input('Date.end_time', array('type' => 'text', 'div' => FALSE));
		echo $this->Form->input('Date.date_end_slide', array(
			'type' => 'range',
			'min' => '4',
			'max' => '42',
			'step' => '1',
