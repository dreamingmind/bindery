...
echo tab($t).$this->Html->tag('fieldset', $this->element('WorkshopSessions/workshop_session_inputs')).cr();
echo tab($t).$this->Html->tag('fieldset', $this->element('WorkshopSessions/date_inputs')).cr();
