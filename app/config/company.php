...
/**
 * Dreaming Mind specific values
 */
//        Configure::write('company.name', 'Dreaming Mind');
//        Configure::write('company.bindery', 'Dreaming Mind Bindery');
//        Configure::write('company.phone', '(510) 537-9711');
//        Configure::write('company.dotphone', '510.537.9711');
//        Configure::write('company.tollfree', '(877) 443-7326');
//        Configure::write('company.dottollfree', '877.443.7326');
//        Configure::write('company.fax', '(925) 475-6709');
//        Configure::write('company.dotfax', '925.475-6709');
//        Configure::write('company.email', 'ddrake@dreamingmind.com');
//        Configure::write('company.url', 'http://dreamingmind.com');
...
//
        ...
        $config['company.tollfree'] = '(877) 443-7326';
        $config['company.dottollfree'] = '877.443.7326';
